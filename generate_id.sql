...
CREATE TABLE `person` (
  ...
  `occupation` enum('Private Service','Govt Service','Worker') DEFAULT NULL,
  `designation` varchar(64) DEFAULT NULL,
  `education` enum('Primary','SSC','HSC','BA','MA','PHD') DEFAULT NULL,
  `address` text DEFAULT NULL,
  `father_name` varchar(64) DEFAULT NULL,
  `mather_name` varchar(64) DEFAULT NULL,
